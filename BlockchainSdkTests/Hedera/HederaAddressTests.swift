...
struct HederaAddressTests {
    @Test(arguments: [EllipticCurve.ed25519, .ed25519_slip0010, .secp256k1])
    func makeAddress(curve: EllipticCurve) throws {
        ...
        let hederaPrivateKeyRaw = switch curve {
        case .ed25519, .ed25519_slip0010:
            Data(hexString: "0x302e020100300506032b657004220420ed05eaccdb9b54387e986166eae8f7032684943d28b2894db1ee0ff047c52451")
        case .secp256k1:
            Data(hexString: "0x3030020100300706052b8104000a04220420e507077d8d5bab32debcbbc651fc4ca74660523976502beabee15a1662d77ed1")
        default:
            Data()
        }

        let hederaDerPrefixPrivate = switch curve {
        case .ed25519, .ed25519_slip0010:
            ...
            Data(hexString: "0x302e020100300506032b657004220420")
        case .secp256k1:
            ...
            Data(hexString: "0x3030020100300706052b8104000a04220420")
        default:
            Data()
        }
        ...
        let blockchain: Blockchain = .hedera(curve: curve, testnet: false)
