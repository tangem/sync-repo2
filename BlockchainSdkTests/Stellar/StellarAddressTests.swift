...
struct StellarAddressTests {
    ...
    func validateCorrectAddress() {
        ...
        #expect(!addressService.validate("GDWFc"))
        #expect(!addressService.validate("GDWFHядыфлвФЫВЗФЫВЛ++EÈ"))
        #expect(addressService.validate("GDWFHB6YWOF5T34AXW6HRUGX4HCT6CHCNFBWZGOVWPBN6SZM44YBFUDZ"))
    }
    ...
    func xlm(blockchain: Blockchain) throws {
