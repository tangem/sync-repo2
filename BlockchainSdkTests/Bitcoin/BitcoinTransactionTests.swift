...
final class BitcoinTransactionTests {
    ...
    @Test
    func legacyAddress() {
        #expect(addressService.validate("1KWFv7SBZGMsneK2ZJ3D4aKcCzbvEyUbAA"))
    }

    @Test
    func segwitAddressValidation() {
        #expect(addressService.validate("bc1qxzdqcmh6pknevm2ugtw94y50dwhsu3l0p5tg63"))
    }

    @Test
    func testTaprootAddressValidation() {
        #expect(addressService.validate("bc1pyzns9j3llzxar0dd50nrus6p0cdqjxxqz6y33cmml3qsedlejsyq867kcg"))
    }

    @Test
    func txBuilder() throws {
