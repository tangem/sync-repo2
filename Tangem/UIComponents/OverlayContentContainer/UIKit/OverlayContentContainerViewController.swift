...
final class OverlayContentContainerViewController: UIViewController {
    ...
    func expand() {
        ...
        UIView.animate(withDuration: Constants.defaultAnimationDuration) { // TODO: Andrey Fedorov - Animations should take gesture speed into account (IOS-7364)
    ...
    func onPanGestureChanged(_ gestureRecognizer: UIPanGestureRecognizer) {
        ...
        overlayViewTopAnchorConstraint?.constant = newVerticalOffset // TODO: Andrey Fedorov - Add rubber-banding (IOS-7364)
