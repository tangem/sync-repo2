...
final class PolkaDotAccountHealthChecker {
    ...
    private let encoder: JSONEncoder // TODO: Andrey Fedorov - Move into separate entity like network provider
    ...
    private func isTransactionImmortal(_ transaction: SubscanAPIResult.ExtrinsicsList.Extrinsic) async throws -> Bool {
        ...
        try await _Concurrency.Task.sleep(seconds: Constants.transactionInfoCheckDelay) // TODO: Andrey Fedorov - Add some random jitter
