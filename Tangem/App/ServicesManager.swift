...
class ServicesManager {
    ...
    private var pushNotificationsInteractor: CommonPushNotificationsInteractor { CommonPushNotificationsInteractor.shared } // FIXME: Andrey Fedorov - Test only, remove when not needed
